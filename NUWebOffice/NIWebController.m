...
@property (nonatomic, strong) NSMutableURLRequest* loadRequest;
@end
...
//  }
  ...
  [self.view addSubview:self.toolbar];
    ...
    if (![NUUtility isNetworkAvailable]){
        [self.loadRequest setCachePolicy:NSURLRequestReturnCacheDataDontLoad];
    }
...
//    NSArray* cookieArray = [NSArray arrayWithObjects: [[SPAuthCookies sharedSPAuthCookie] rtFa],
