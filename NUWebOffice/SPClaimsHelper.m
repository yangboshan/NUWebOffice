...
@synthesize delegate = _tokenDelegate;
@synthesize username;
@synthesize password;
@synthesize siteUrl;
...
- (void)connectionDidFinishLoading:(NSURLConnection	 *)connection
{
    ...
    //SMXMLElement *lifeTimeElement = [tokenResponseElement childNamed:@"Lifetime"];
    //NSString *expires = [lifeTimeElement valueWithPath:@"Expires"];
